  ...
  return (
    <div className="flex flex-col gap-7 md:gap-16">
      <BannerHero
        ...
        description="Somos 5 filiales en el país, con equipo de instructores y recursos propios, para continuar multiplicando manos que salvan vidas"
      />

      <div className="px-4 md:px-0 container mx-auto flex flex-col gap-7 md:gap-16 pb-7 md:pb-16">
        <div>
          <Titleh1
            title="Expandiendo Nuestra Misión: 5 Filiales en Todo el País"
          ...
          <div className="w-full space-y-1">
            <p>
              ...
              que confían en Argentina Reanima. Somos 5 filiales en el país, con
              equipo de instructores y recursos propios, para continuar
              multiplicando manos que salvan vidas.
            </p>
            <p>
              Rio Grande, Mar del Plata, Puerto Iguazú, Río Tercero y La Plata.
