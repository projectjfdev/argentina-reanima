...
//               >
//                 Registre su cuenta y acceda a su panel administrativo para
//                 gestionar la informacion de su página web
//               </motion.p>
//             </div>
//           </div>
//         </div>
...
const RegisterPage = () => {
  return (
    <div className="h-[600px] flex flex-col items-center justify-center">
      <h4>Si necesitas crear un nuevo usuario, consultar al programador</h4>
    </div>
  );
};
